...
const createUser = async (userData) => {
    const { first_name, last_name, dob, address, place, city, district, state, email, phone, password, role } = userData;
    ...
    const values = [first_name, last_name, dob, address, place, city, district, state, email, phone, password, role || 'customer'];
